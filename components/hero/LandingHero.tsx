          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center h-[90vh]">
            <div className="flex flex-col justify-center">
              <h1 className="md:text-5xl text-2xl font-extrabold text-[#1F1F1F] font-dmSans">
                Join procurenet and sell out your products to verified
                businesses
              </h1>
              <p className="text-sm md:text-xl text-[#1F1F1F] mt-4">
                The ultimate solution for hotels and restaurants to simplify
                their purchasing processes. Discover, order and manage supplies
