...
interface ProcurementCurrencyInputFieldProps {
  label: string;
  placeholder: string;
...
function ProcurementCurrencyInputField({
  placeholder,
  id,
  name,
  touched,
  ...
  required,
  defaultalue,
}: ProcurementCurrencyInputFieldProps) {
  return (
    <div>
      <label
        htmlFor={name}
...
export default ProcurementCurrencyInputField;
